                            ...
                            <form onSubmit={HandleOnsubmitAppointment}>
                                ...
                                <div className='flex mx-10 my-3'>
                                    ...
                                    <input
                                        ...
                                        onChange={HandleAppointment}
                                        required
                                        className='border border-gray-800 rounded-lg bg-[rgb(245,245,245)]  w-[80%] h-[50px]'
                                    />
                                </div>
                                <div className='flex mx-10 my-3'>
                                ...
                                <div className='flex mx-10 my-3'>
                                    ...
                                    <input
                                        ...
                                        onChange={HandleAppointment}
                                        required
                                        className='bg-[rgb(245,245,245)] border border-gray-800 rounded-lg w-[80%] h-[50px]'
                                    />
                                </div>
                                <div className='flex mx-10 my-3'>
                                ...
                                <div className='flex mx-10 my-3'>
                                    ...
                                    >
                                        ...
                                        <option value=" 7655435343">Ishwar</option>
                                    </select>
                                </div>
                                <div className='flex mx-10 my-3'>
