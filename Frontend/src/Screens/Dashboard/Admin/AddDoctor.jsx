              ...
              <form onSubmit={HandleDoctorSubmit}>
                <div className='flex mx-10 my-3'>
                  ...
                  <input
                    ...
                    required
                    className='bg-[rgb(245,245,245)] w-[80%] h-[50px] border border-gray-700 rounded-lg'
                  />
                </div>
                <div className='flex mx-10 my-3'>
                ...
                <div className='flex mx-10 my-3'>
                  ...
                  <select
                    ...
                    onChange={HandleDoctorChange}
                    required
                    className='bg-[rgb(245,245,245)] w-[80%] h-[50px] pl-2 text-[#A8A3AF] border border-gray-700 rounded-lg'
                  >
                ...
                <div className='flex mx-10 my-3'>
                  ...
                  <textarea
                    ...
                    onChange={HandleDoctorChange}
                    required
                    className='bg-[rgb(245,245,245)] w-[80%] border border-gray-700 rounded-lg'
                  />
                </div>
