...
const DLogin = () => {
  ...
  return (
    <>
      <ToastContainer />
      <div className='h-[100vh] w-[100vw] bg-gradient-to-br to-green-800 from-green-400 flex items-center justify-center'>
        <div className='h-[60%] w-[60%]  rounded-2xl bg-lightGrey flex shadow-2xl'>
          <div className='w-1/2 h-full rounded-2xl bg-lightGrey flex justify-center items-center'>
            <div>
              ...
              <div className='mt-2 flex items-center justify-center '>
              <span className='font-bold'>Password - unknown</span> 
              </div>
            </div>
          </div>
          <div className='w-1/2 h-full border-l-2 px-3 py-4'>
            <div>
              ...
              <div className='w-full flex items-center justify-center  py-2 font-bold'>
                ...
                >
                  <Radio.Button value="Nurse" className={"radiobutton hover:text-green-700 "}>
                    Nurse
                  </Radio.Button>
                  <Radio.Button value="Doctor" className={"radiobutton hover:text-green-700"}>
                    Doctor
                  </Radio.Button>
                  <Radio.Button value="Admin" className={"radiobutton hover:text-green-700"}>
                    Admin
                  </Radio.Button>
                </Radio.Group>
              </div>
            ...
            <div className='mt-3  flex items-center justify-center'>
              <form onSubmit={HandleSubmit} >
                ...
                <input
                  ...
                  required
                  className='rounded-xl w-full px-3 border border-gray-400 '
                  placeholder='ID'
                />
                ...
                <div className='flex items-center justify-center'>
                  <button type="submit" className='w-[80%] py-1 text-white bg-gradient-to-r to-green-800 from-green-600 rounded-2xl mt-5 font-bold'>{Loading ? "Loading..." : "Submit"}</button>
                </div>
                ...
                >
                  ...
                  <button className='bg-mediumBlue text-white'
                    style={{
                      width: "50%",
                      margin: " 20px auto",
                      display: "flex",
